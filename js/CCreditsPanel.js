function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text(TEXT_DEVELOPED," 36px "+FONT_GAME, "#fff");
        oTitle.y = -70;
        oTitle.textAlign = "center";
        oTitle.textBaseline = "alphabetic";
        _oContainerPanel.addChild(oTitle);

        var oLink = new createjs.Text("www.betobet.com"," 32px "+FONT_GAME, "#fff");
        oLink.y = 86;
    ...
    this._onLogoButRelease = function(){
        window.open("http://www.betobet.com/sports");
    };
