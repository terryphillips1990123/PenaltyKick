function CWinPanel(oSpriteBg) {
    ...
    this._init = function (oSpriteBg) {
        ...
        //            CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT_HALF-150, oSpriteBg.width, 90, 
        ...
        _oTitleText = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT_HALF-150, oSpriteBg.width, 90, 
                    70, "center",TEXT_COLOR, FONT_GAME, 1.1,
                    50, 0,
                    TEXT_GAMEOVER_1,
                    true, true, false,
                    false );
        ...
        _oNewScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH / 2 -oSpriteBg.width/2, CANVAS_HEIGHT_HALF-60, oSpriteBg.width, 70, 
        ...
        var oSpriteButGo = s_oSpriteLibrary.getSprite('but_go');
        _oButGo = new CGfxButton(CANVAS_WIDTH * 0.5, CANVAS_HEIGHT * 0.5 + 120, oSpriteButGo, _oGroup);
        _oButGo.addEventListener(ON_MOUSE_DOWN, this._onGO, this);
    ...
    this.show = function (iScore) {
        if(iScore > 210){
            //_oTitleTextStoke.refreshText(TEXT_GAMEOVER_1);
            _oTitleText.refreshText(TEXT_GAMEOVER_1);
            _oButGo.setVisible(true);
        }
        else{
            //_oTitleTextStoke.refreshText(TEXT_GAMEOVER_2);
            _oButGo.setVisible(false);
            _oTitleText.refreshText(TEXT_GAMEOVER_2);
        }
    ...
    this._onGO = function () {
        ...
        window.open('https://go.betobet.online/visit/?bta=35288&nci=5473');
        this.unload();
        s_oGame.restartGame();
    };
