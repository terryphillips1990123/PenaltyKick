function CGame(oData) {
    ...
    this._init = function () {
        ...
        _oGoal = new CGoal(216, 612, oSprite, _oContainerGame);

        _oGoalKeeper = new CGoalKeeper(CANVAS_WIDTH_HALF - 100, CANVAS_HEIGHT_HALF - 25, _oContainerGame);
        ...
        _oPlayer = new CPlayer(CANVAS_WIDTH_HALF - 50, CANVAS_HEIGHT_HALF + 230, _oContainerGame);
    ...
    this.convert3dPosTo2dScreen = function (pos, oCamera) {
        ...
        var heightHalf = Math.floor(s_iCanvasResizeHeight) * 0.7;
    ...
    this.ballOut = function () {
        if (!_bBallOut && !_bGoal && !_bSaved) {
            ...
            if (oPos.y > BALL_OUT_Y + 120 || oPos.x > BACK_WALL_GOAL_SIZE.width * 0.5|| oPos.x < -BACK_WALL_GOAL_SIZE.width * 0.5) {
                _bBallOut = true;
